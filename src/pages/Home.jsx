...
const Home = () => {
  // Raw data for tasks, to be processed.
  ...
  // Process data to include dynamic titles for the Kanban board
  const columnsWithDynamicTitles = columnsRawData.map(column => ({
    ...column,
  ...
  return (
    <div className="p-4">
      {/* Statistics can use the raw data */}
      <Statistics columns={columnsRawData} />
      {/* Kanban board gets the dynamically generated titles */}
      <KanbanBoard columns={columnsWithDynamicTitles} />
    </div>
  );
};
